...
def update_RealOptSolutionOWA(cheminLog):
...
\nSoit un gap de {100-valeur_sol_estimee*100/valeur_sol_optimale} %")
    ...
    log.close()
    update_RealOptSolutionOWA(filename)
    #update_log_OWA()
